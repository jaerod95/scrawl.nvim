...
- `/cp-plan` — Start a planning session from a Jira ticket
- `/cp-note` — Capture a note with file context
- `/cp-decision` — Capture a decision
- `/cp-notes` — Display captured notes
- `/cp-spec` — Write a spec from notes
