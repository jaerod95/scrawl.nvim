---
name: cp-decision
description: Use when the user invokes /cp-decision to capture a planning decision. Appends a DECISION-prefixed note to the current planning session's notes.md file.
---
...
The argument may include editor context in brackets: `/cp-decision [file:line] text`
